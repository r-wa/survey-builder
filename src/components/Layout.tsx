...
import { ClipboardList, Home, List, Plus } from 'lucide-react';
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 sm:py-0">
            ...
            {/* Navigation */}
            <nav className="flex flex-row justify-center py-2 sm:py-0">
              <div className="flex space-x-1 sm:space-x-4 px-2 py-1 rounded-lg bg-gray-50 sm:bg-transparent">
                <Link 
                  to="/" 
